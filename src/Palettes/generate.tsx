...
const hueStep = 2; // 色相階梯
const saturationStep = 0.16; // 飽和度階梯，淺色部分
const saturationStep2 = 0.05; // 飽和度階梯，深色部分
const brightnessStep1 = 0.05; // 亮度階梯，淺色部分
const brightnessStep2 = 0.15; // 亮度階梯，深色部分
const lightColorCount = 5; // 淺色數量，主色上
const darkColorCount = 4; // 深色數量，主色下
// 暗色主題顏色映射關係表
const darkColorMap = [
